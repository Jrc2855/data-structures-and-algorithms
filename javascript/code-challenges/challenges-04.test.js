...
const updateAnimal = (arr, callback) => {
  ...
  for(let i = 0; i < arr.length; i++) {
    arr.foreach(str => {
      let val = callback(str.toUpperCase);
      let otherVal = callback(str.toLowerCase);
      newArr.push(val);
      newArr.push(otherVal);
    });
    return newArr;
  }
//! Test still not passing
};
...
// I got help from this site when I was looking for solutions.
