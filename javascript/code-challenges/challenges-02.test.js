...
const raisedToTheThird = (arr) => {
  ...
  let toTheThirdArray = [];
  arr.forEach(number => {
    let toTheThirdNumber = Math.pow(number, 3);
    toTheThirdArray.push(toTheThirdNumber);
  });
  return toTheThirdArray;
};
...
const addOne = (arr) => {
  // Solution code here...
  let addedNumbers = arr.map(function(x) {
    return x + 1;
  });
  return addedNumbers;
};
...
const addQuestion = (arr) => {
  // Solution code here...
  var questionArr = arr.map(function (string) {
    return string + '?';
  });
  return questionArr;
};
...
const forLoopTwoToThe = (arr) => {
  ...
  for(let i = 0; i < arr.length; i++){
    increasedArr.push(Math.pow(2, arr[i]));
  }
  return increasedArr;
};
...
const forEachTwoToThe = (arr) => {
  ...
  arr.forEach(number => {
    let increasedNumber = Math.pow(2, number);
    increasedArr.push(increasedNumber);
  });
  return increasedArr;
};
...
const mapTwoToThe = (arr) => {
  // Solution code here...
  let increasedArr = arr.map(function(x) {
    return Math.pow(2, x);
  });
  return increasedArr;
};
