...
// ! I had help from a friend on the above line of code.

const addValues = (arr) => {
  // Solution code here...
  const addedValues = arr.reduce((accumulator, currentValue) =>
...
// For this one I watched a youtube video from the channel "Web Dev Simplified" on the Array Reduce Method.
const addPurchases = (arr) => {
  // Solution code here...
  const amount = arr.reduce((total, item) => {
...
const countNumberOfElements = (arr) => {
  // Solution code here...
  const amount = arr.reduce((accumulator, current) =>
    (accumulator[current] = accumulator[current]
      ? accumulator[current] += 1
      : accumulator[current] = 1), 0);
  console.log(amount);
  return amount;
};
...
/* ------------------------------------------------------------------------------------------------
CHALLENGE 6
! Code was taken from in class code review
...
! reduce(newStr, character)
! 'A' + '' ->> 'A'
! 'u' + 'A' ->> 'uA'
! 'd' + 'uA ->> 'duA
! initialize an empty string
! split - str.split('') ->> ['J','o','h','n']
